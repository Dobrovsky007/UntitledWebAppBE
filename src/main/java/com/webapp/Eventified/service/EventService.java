...
public class EventService {
     ...
     */
    public Event createEvent(String username, String title, Integer sport, String address, Integer skillLevel,
            LocalDateTime startTime, LocalDateTime endTime, Integer capacity, BigDecimal latitude,
        ...
        Event event = new Event(organizer, title, sport, skillLevel, address, latitude, longitude, startTime, endTime,
                capacity);
    ...
    public List<EventPoolDTO> getMyAttendedPastEvents(String username){
        ...
        List<EventPoolDTO> pastAttendedEvents = eventParticipantRepository.findByUserIdAndRoleOfParticipant(user.getId(), 1)
                .stream()
